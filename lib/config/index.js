...
module.exports = function config(userConfiguration = {}) {
    ...
    const statsdClient = Object.assign(
        {
            host: STATSD_HOST,
            port: parseInt(STATSD_PORT, 10) || undefined
        },
        userConfiguration.statsdClient || {}
    );
    ...
    statsdClient.host || missing.push('statsd host');
    statsdClient.port || missing.push('statsd port');
